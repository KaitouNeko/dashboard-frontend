...
import ESGReportTemplate, { ESGReportData } from './ESGReportTemplate';
...
const ESGReportGenerator: React.FC<ESGReportGeneratorProps> = ({ 
  reportData, 
  ...
  return (
    <div className="esg-report-generator">
      ...
      <div className="preview-container mb-6">
        <ESGReportTemplate data={reportData} />
      </div>
